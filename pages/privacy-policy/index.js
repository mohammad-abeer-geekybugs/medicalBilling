...
const Policy = () => {
  return (
    <Container maxW="80%" my="5rem" textAlign="justify">
      <Box>
        <Heading my="1rem">Website Terms of Use</Heading>
        <Text my="1rem">Version 1.0</Text>
        <Text my="1rem">
          The Medical Business website located at medical-billing.com is a
          copyrighted work belonging to GeekyBugs. Certain features of the Site
      ...
      <Box>
        <Heading my="1rem">Access to the Site</Heading>
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>Subject to these Terms. </span>
        ...
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>Certain Restrictions. </span>
        ...
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>No Support or Maintenance. </span>
      ...
      <Box>
        <Heading my="1rem">{`Third-Party Links & Ads; Other Users`}</Heading>
        <Text my="1rem">
        ...
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>Other Users.</span>
      ...
      <Box>
        <Heading my="1rem">Disclaimers</Heading>
        <Text my="1rem">
      ...
      <Box>
        <Heading my="1rem">Limitation on Liability</Heading>
        <Text my="1rem">
        ...
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>Term and Termination.</span>{" "}
      ...
      <Box>
        <Heading my="1rem">Copyright Policy.</Heading>
        <Text my="1rem">
      ...
      <Box>
        <Heading my="1rem">General</Heading>
        <Text my="1rem">
        ...
        <Text my="1rem">
          ...
          the Company should be sent to: Lahore, Pakistan. After the Notice is
        ...
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>Arbitration Rules.</span>{" "}
        ...
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>Time Limits.</span> If you or the
        ...
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>Authority of Arbitrator.</span> If
        ...
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>Waiver of Jury Trial.</span> THE
        ...
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>Confidentiality.</span> All
        ...
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>Severability.</span> If any part
        ...
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>Right to Waive.</span> Any or all
          of the rights and limitations set forth in this Arbitration Agreement
        ...
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>Electronic Communications.</span>{" "}
        ...
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>Entire Terms.</span> These Terms
          constitute the entire agreement between you and us regarding the use
          of the Site. Our failure to exercise or enforce any right or provision
        ...
        <Text my="1rem">
          <span style={{ fontWeight: "600" }}>Your Privacy.</span> Please read
          our Privacy Policy.
        </Text>
      ...
      <Box>
        <Heading my="1rem">Contact Information</Heading>
        <Text my="1rem">Address: Lahore, Pakistan</Text>
        <Text my="1rem">Email: muhammad.asad@geekybugs.com</Text>
      </Box>
    </Container>
  );
};
